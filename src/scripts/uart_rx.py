...
def build_structure() -> List[Dict[str, Union[str, int]]]:
    ...
    structure.append({ 'name': 'copyframe_busy2', 'size': 1 })
    structure.append({ 'name': 'scan_underflow_sticky2', 'size': 1 })
    structure.append({ 'name': 'scan_cache_valid2', 'size': 2 })
    structure.append({ 'name': 'scan_prefetch_in_progress2', 'size': 1 })
    structure.append({ 'name': 'sdram_refresh_active2', 'size': 1 })
    structure.append({ 'name': 'sdram_init_done2', 'size': 1 })
