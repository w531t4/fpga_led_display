...
loopviz: $(ARTIFACT_DIR)/mydesign_show.svg ## Render Yosys graphviz loop visualization
$(ARTIFACT_DIR)/mydesign_show.svg: $(ARTIFACT_DIR)/mydesign_show.dot | $(ARTIFACT_DIR)
	$(TOOLPATH)/dot -Kdot -o $@ -Tsvg $<

loopviz_pre: $(ARTIFACT_DIR)/mydesign_show_pre.svg ## Render pre-optimization Yosys graphviz loop visualization
...
diagram: $(DIAGRAM_TARGETS) ## Render netlistsvg diagrams
