|description            |subdesc   |TinyFPGA BX|HUB75 pin|Icecube pin|IC PIN|Waveforms|tempmove|
|-----------------------|----------|-----------|---------|-----------|------|---------|--------|
|                       |          |GND        |4,8,16
|baudrate_reset         |          |1          |         |           |A2
|timeout_word           |          |2          |         |           |A1    |
...
|---------------------------------|
   ...
   D   L   3   1    D   2   D   1
```
Attie has a way better diagram of HUB75 layour here
https://github.com/attie/led_matrix_tinyfpga_a2/blob/master/doc/rgb_led_matrix_pinout.svg
