...
|description            |subdesc   |TinyFPGA BX|HUB75 pin|RPI PIN     |USB UART  |Icecube pin|IC PIN|Waveforms|tempmove|
|-----------------------|----------|-----------|---------|------------|----------|-----------|------|---------|--------|
|                       |          |GND        |4,8,16   |6           |          |
|baudrate_reset         |          |1          |         |            |          |           |A2
|timeout_word           |          |2          |         |            |          |           |A1    |
|A row_address_active[0]|rx_data[2]|3          |9        |            |          |pin3       |B1    |4
...
|Green 1 Rgb1[1]        |          |13         |2        |            |          |pin13      |H2    |8
|                       |rx_data[4]|14         |         |            |          |           |H9    |
|                       |rx_data[5]|15         |         |            |          |           |D9    |
|                       |rx_data[6]|16         |         |            |          |           |D8    |
|                       |rx_data[7]|17         |         |            |          |           |C9    |
