...
VERILATOR_SIM_MAKEFLAGS += $(if $(strip $(VERILATOR_OPT_SLOW)),OPT_SLOW=$(VERILATOR_OPT_SLOW))
VERILATOR_SIM_MAKEFLAGS += $(if $(strip $(VERILATOR_OBJCACHE)),OBJCACHE=$(VERILATOR_OBJCACHE))
